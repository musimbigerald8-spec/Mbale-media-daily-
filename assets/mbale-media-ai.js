(function () {
  ...
  style.textContent = `
    #mbmd-ai-launcher{position:fixed;right:18px;bottom:18px;z-index:99999;border:0;border-radius:999px;background:#e4032e;color:#fff;padding:15px 20px;font:800 14px Arial,sans-serif;box-shadow:0 8px 24px #0005;cursor:pointer;display:block!important;visibility:visible!important;opacity:1!important}
