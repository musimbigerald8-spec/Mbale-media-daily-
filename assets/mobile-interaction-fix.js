/* Mbale Media Daily — mobile menu + continuous breaking ticker v6 + Eastlink advert */
(function(){
'use strict';
function menu(){
...
function go(){
  ...
  menu();ticker();advert();
  var i=0,t=setInterval(function(){menu();ticker();advert();if(++i>30)clearInterval(t);},250);
}
